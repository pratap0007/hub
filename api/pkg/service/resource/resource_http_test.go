...
func TestQueryWithAllParams_Http(t *testing.T) {
	...
	QueryChecker(tc).Test(t, http.MethodGet, "/query?name=build&kinds=task&kinds=Pipeline&categories=abc&tags=ztag&tags=Atag&exact=false").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestQueryWithCategories_Http(t *testing.T) {
	...
	QueryChecker(tc).Test(t, http.MethodGet, "/query?categories=abc").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestQueryWithCategoriesAndName_Http(t *testing.T) {
	...
	QueryChecker(tc).Test(t, http.MethodGet, "/query?name=build&categories=abc").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestQueryWithCategoriesAndTags_Http(t *testing.T) {
	...
	QueryChecker(tc).Test(t, http.MethodGet, "/query?categories=abc&tags=ztag&tags=Atag").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestQueryWithCategoriesAndKinds_Http(t *testing.T) {
	...
	QueryChecker(tc).Test(t, http.MethodGet, "/query?categories=abc&kinds=Pipeline").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestByCatalogKindName_CompatibleVersion_Http(t *testing.T) {
	...
	ByCatalogKindNameChecker(tc).Test(t, http.MethodGet, "/resource/catalog-official/task/tekton?pipelinesversion=0.12.3").Check().
		HasStatus(200).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestByCatalogKindName_InvalidPipelinesVersion_Http(t *testing.T) {
	...
	ByCatalogKindNameChecker(tc).Test(t, http.MethodGet, "/resource/catalog-official/task/tekton?pipelinesversion=asd").Check().
		HasStatus(400).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestByCatalogKindName_InvalidPipelinesVersion_Error_Http(t *testing.T) {
	...
	ByCatalogKindNameChecker(tc).Test(t, http.MethodGet, "/resource/catalog-official/task/tekton?pipelinesversion=v0.12.3").Check().
		HasStatus(400).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
...
func TestByCatalogKindName_ValidPipelinesVersion_Http(t *testing.T) {
	...
	ByCatalogKindNameChecker(tc).Test(t, http.MethodGet, "/resource/catalog-official/task/tekton?pipelinesversion=0.13").Check().
		HasStatus(200).Cb(func(r *http.Response) {
...
func TestByCatalogKindName_NoCompatibleVersion_Http_ErrorCase(t *testing.T) {
	...
	ByCatalogKindNameChecker(tc).Test(t, http.MethodGet, "/resource/catalog-official/task/tekton?pipelinesversion=0.11.0").Check().
		HasStatus(404).Cb(func(r *http.Response) {
		b, readErr := ioutil.ReadAll(r.Body)
		assert.NoError(t, readErr)
		defer r.Body.Close()
